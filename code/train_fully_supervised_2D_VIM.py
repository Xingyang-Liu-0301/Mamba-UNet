...
from dataloaders.dataset_scribblevc import ACDCDataSets, RandomGenerator
from torch.nn import CrossEntropyLoss # 确保导入了 Loss
from networks.net_factory import net_factory
from utils import losses, metrics, ramps
from val_2D import test_single_volume, test_single_volume_ds, test_single_fracture

parser = argparse.ArgumentParser()
parser.add_argument('--root_path', type=str,
                    default='/data/lxy/Datasets/longbone_224_240822_rip', help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='LongBone/mamba', help='experiment_name')
...
parser.add_argument(
    '--cfg', type=str, default="/data/lxy/python_projects/Mamba-UNet-main/code/configs/vmamba_tiny.yaml", help='path to config file', )
parser.add_argument(
    "--opts",
...
def train(args, snapshot_path):
    ...
    ]), sup_type="skeletonized_labelcol") # 👈 确保这里填的是你弱标签文件夹的名字
